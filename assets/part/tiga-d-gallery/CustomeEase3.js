...
!(function (e, t) {
    ...
    function stringToRawPath(e) {
        ...
        for (t = 0; t < w; t++)
            if (((g = o), isNaN(m[t]) ? (r = (o = m[t].toUpperCase()) !== m[t]) : t--, (s = +m[t + 1]), (i = +m[t + 2]), r && ((s += x), (i += y)), t || ((u = s), (h = i)), "M" === o))
                a && (a.length < 8 ? --p.length : (C += a.length)), (x = u = s), (y = h = i), (a = [s, i]), p.push(a), (t += 2), (o = "L");
            ...
            else if ("L" === o || "Z" === o) "Z" === o && ((s = u), (i = h), (a.closed = !0)), ("L" === o || 0.5 < B(x - s) || 0.5 < B(y - i)) && (ib(x, y, s, i), "L" === o && (t += 2)), (x = s), (y = i);
            else if ("A" === o) {
                if (
                    ((v = m[t + 4]),
                    (d = m[t + 5]),
                    ...
                    (c = m[t + 7]),
                    (n = 7),
                    1 < v.length && (v.length < 3 ? ((c = f), (f = d), n--) : ((c = d), (f = v.substr(2)), (n -= 2)), (d = v.charAt(1)), (v = v.charAt(0))),
    ...
    function C(e, t, n, s, i, o, r, a, u, h, f) {
        ...
        return (
            ...
            u * (P * P + S * S) < (N + T) * (N + T) && ((c = h.length), C(e, t, l, g, x, y, E, b, u, h, f), C(E, b, w, M, m, p, r, a, u, h, f + 1 + (h.length - c))),
            h
        );
    }
    var y,
            ...
            for (
                setTimeout(function () {
                    window &&
                        ...
                        (console.log(v(37, 99, 87, 97, 114, 110, 105, 110, 103), v(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)),
                        console.log(
                        ...
                        console.log(
                            ...
                            v(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)
                        ),
        ...
        n =
            (((t = CustomEase.prototype).setData = function setData(e, t) {
                ...
                for (
                    ...
                    (s = { x: +c[o - 2], y: +c[o - 1] }), (i = { x: +c[o + 4], y: +c[o + 5] }), g.push(s, i), C(s.x, s.y, +c[o], +c[o + 1], +c[o + 2], +c[o + 3], i.x, i.y, 1 / (2e5 * d), g, g.length - 1);
                    ...
                    (u = g[o]),
                        ...
                        (u.x > h.x || (h.y !== u.y && h.x === u.x) || u === h) && u.x <= 1
                            ? ((h.cx = u.x - h.x),
                              ...
                              h.cx < l && (h.cx ? (l = h.cx) : ((h.cx = 0.001), o === n - 1 && ((h.x -= 0.001), (l = Math.min(l, 0.001)), (m = 0)))))
                            : (g.splice(o--, 1), n--);
                if (((r = 1 / (n = (1 / l + 1) | 0)), (u = g[(a = 0)]), m)) {
                    for (o = 0; o < n; o++) (f = o * r), u.nx < f && (u = g[++a]), (s = u.y + ((f - u.x) / u.cx) * u.cy), (v[o] = { x: f, cx: r, y: s, cy: 0, nx: 9 }), o && (v[o - 1].cy = s - v[o - 1].y);
            ...
            (CustomEase.getSVGData = function getSVGData(e, t) {
                ...
                if ((t.invert && ((v = -v), (p = 0)), "string" == typeof e && (e = y.parseEase(e)), e.custom && (e = e.custom), e instanceof CustomEase))
                    n = (function rawPathToString(e) {
                        ...
                        (function transformRawPath(e, t, n, s, i, o, r) {
                            for (var a, u, h, f, c, l = e.length; -1 < --l; ) for (u = (a = e[l]).length, h = 0; h < u; h += 2) (f = a[h]), (c = a[h + 1]), (a[h] = f * t + c * s + o), (a[h + 1] = f * n + c * i + r);
                            return (e._dirty = 1), e;
                        })([e.segment], g, 0, 0, -v, d, p)
                    );
                else {
                    for (n = [d, p], r = 1 / (h = Math.max(5, 200 * (t.precision || 1))), f = 5 / (h += 2), c = s(d + r * g), i = ((l = s(p + e(r) * -v)) - p) / (c - d), o = 2; o < h; o++)
                        (a = s(d + o * r * g)), (u = s(p + e(o * r) * -v)), (Math.abs((u - l) / (a - c) - i) > f || o === h - 1) && (n.push(c, l), (i = (u - l) / (a - c))), (c = a), (l = u);
                    n = "M" + n.join(",");
                }
